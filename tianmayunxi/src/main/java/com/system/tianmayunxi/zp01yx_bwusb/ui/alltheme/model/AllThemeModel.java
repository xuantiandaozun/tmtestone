package com.system.tianmayunxi.zp01yx_bwusb.ui.alltheme.model;

import com.system.tianmayunxi.zp01yx_bwusb.bean.TMBaseResoultEntity;
import com.system.tianmayunxi.zp01yx_bwusb.ui.alltheme.api.MainService;
...
public class AllThemeModel  implements AllThemeContract.Model {
    ...
    public Observable<TMBaseResoultEntity<Object>> uploadIv(List<MultipartBody.Part> partList) {
        return com.system.tianmayunxi.zp01yx_bwusb.api.MainService.getMainService().uploadFile(partList)
                //在新线程中执行登录请求
                .subscribeOn(Schedulers.newThread())
                //在主线程中执行;
                .observeOn(AndroidSchedulers.mainThread());
